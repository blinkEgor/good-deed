...
export function RevenueChartSkeleton() {
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      ...
      <div className="rounded-xl bg-gray-600 p-4">
        <div className="mt-0 grid h-[410px] grid-cols-12 items-end gap-2 rounded-md bg-gray-500 p-4 sm:grid-cols-13 md:gap-4" />
  ...
  return (
    <div className="mb-2 w-full rounded-md bg-gray-700 p-4">
      <div className="flex items-center justify-between border-b border-gray-100 pb-8">
        ...
        {/* <div className="h-6 w-64 rounded bg-gray-600"></div> */}
      </div>
      <div className="flex w-full items-center justify-between pt-4">
        <div>
          <div className="h-6 w-64 rounded bg-gray-500"></div>
