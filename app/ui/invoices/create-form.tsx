    ...
    <form action={dispatch}>
          ...
          <div className="rounded-md border border-gray-500 bg-gray-600 px-[14px] py-3">
            <div className="flex gap-4">
              <div className="flex items-center">
                ...
                <label
                  htmlFor="doing"
                  className="ml-2 flex cursor-pointer items-center gap-1.5 rounded-full bg-gray-600 px-3 py-1.5 text-xs font-medium text-gray-200"
                >
      ...
      <div className="mt-6 flex justify-end gap-4">
        <Link
          ...
          className="flex h-10 items-center rounded-lg bg-gray-500 px-4 text-sm font-medium text-gray-200 transition-colors hover:bg-gray-200"
        >
          Cancel
        </Link>
